...
from ct200.domain.exceptions import TreeValidationError
from ct200.domain.value_objects import ContentHash
...
class TreeEngine:
    ...
    def build_tree(self, content: ParsedContent, version_id: str = "") -> DocumentTree:
        ...
        root = DocumentNode(
            ...
            content_hash=ContentHash.compute("root", ""),
        )
        ...
        for block in blocks:
            if block.block_type == BlockType.HEADING and block.level > 0:
                ...
                node = DocumentNode(
                    ...
                    lineage_id=str(uuid.uuid4()),
                    content_hash=ContentHash.compute(block.content, ""),
                )
    ...
    def _flush_body(
        ...
        current_node.content_hash = ContentHash.compute(
