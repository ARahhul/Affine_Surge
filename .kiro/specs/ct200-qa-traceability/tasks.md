...
- [ ] 1. Phase 1 — Engineering Foundation
  - [ ] 1.1 Create project skeleton with pyproject.toml and folder structure
  ...
  - [~] 1.3 Implement structured JSON logging with correlation IDs
  ...
  - [~] 1.4 Implement health, readiness, and metrics endpoints
  ...
  - [~] 1.5 Implement FastAPI app factory with dependency injection
  ...
  - [~] 1.6 Implement domain exception hierarchy and global error handler
  ...
  - [~] 1.7 Set up CI pipeline configuration
  ...
  - [~] 1.8 Create Dockerfile and docker-compose.yml
...
- [ ] 3. Phase 2 — PDF Intelligence

  - [~] 3.1 Implement PDF parser with PyMuPDF
  ...
  - [~] 3.4 Implement parser reporting and reconciliation
  ...
  - [~] 3.5 Implement parser hardening (fail-closed behavior)
...
- [~] 4. Checkpoint — PDF Parser validation
  - Ensure all tests pass, ask the user if questions arise.
